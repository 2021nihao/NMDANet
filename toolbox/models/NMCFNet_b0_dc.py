...
from backbone.SegFormer_master.mmseg.models.backbones.mix_transformer import mit_b3, mit_b0
...
class NMCFNet(nn.Module):
    def __init__(self):
        ...
        if self.training:
            self.rgb.load_state_dict(torch.load("/XX/XX/XX/XX/XX/XX/SegFormer_master/weight/mit_b0.pth"), strict=False)
            self.d.load_state_dict(torch.load("/XX/XX/XX/XX/XX/XX/SegFormer_master/weight/mit_b0.pth"), strict=False)
        ...
        self.nm_r1 = NM(c1=32, c2=64, c=48)
        self.nm_r2 = NM(c1=64, c2=160, c=48)
        self.nm_r3 = NM(c1=160, c2=256, c=48)

        self.nm_d1 = NM(c1=32, c2=64, c=48)
        self.nm_d2 = NM(c1=64, c2=160, c=48)
        self.nm_d3 = NM(c1=160, c2=256, c=48)

        self.cf_1 = CFM(c=48)
        self.cf_2 = CFM(c=48)
        self.cf_3 = CFM(c=48)

        self.sae = SAE(c4=256, c=48)
        ...
        self.conv_r4 = nn.Conv2d(256, 1, 1, 1)
        self.conv_d4 = nn.Conv2d(256, 1, 1, 1)
